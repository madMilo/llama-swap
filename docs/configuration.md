...
# gpuVramCapMB: clamp GPU VRAM totals used for scheduling
# - optional, default: 0 (disabled)
# - when set, free/total VRAM is capped to this value for all GPUs
gpuVramCapMB: 0

# gpuVramCapsMB: per-GPU VRAM caps (in MB) by index
# - optional, default: []
# - overrides gpuVramCapMB for specific GPUs
gpuVramCapsMB: [24576, 24576]

# hostRamCapMB: total host RAM cap for models without fitPolicy=spill
# - optional, default: 0 (disabled)
# - enforced across running + new processes that are not using --fit via spill
hostRamCapMB: 131072
...
models:
  ...
  "llama":
    ...
    # initialCpuMB: initial CPU/RAM usage hint in MB
    # - optional, default: 0
    # - used until actual measurements are observed from logs
    initialVramMB: 0
    initialCpuMB: 0
